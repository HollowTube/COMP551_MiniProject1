...
# plt.scatter(feature_range, error_list_gradient, color='blue')
# plt.scatter(feature_range, error_list_closed, color='red')
#
# plt.subplot(212)
# plt.title('Time taken vs number of features')
# plt.scatter(feature_range, time_list_gradient, color='blue')
# plt.scatter(feature_range, time_list_closed, color='red')
#
# plt.show()
